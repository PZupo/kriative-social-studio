...
export default function App() {
  ...
  const [baseImage, setBaseImage] = useState<string | null>(null); // Upload base
  const [showTopBand, setShowTopBand] = useState<boolean>(true);   // 🔹 Tarja/cabeçalho opcional
  ...
  try {
    ...
    // A lista “Minhas Criações” será atualizada automaticamente (evento kss:creations:changed)
    alert('✅ Salvo em “Minhas Criações”.');

  } catch (err:any) {
    // Canvas “tainted” (imagem remota sem CORS) costuma lançar SecurityError
